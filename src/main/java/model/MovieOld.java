 ...
 */
@Data
public class MovieOld implements Comparable<MovieOld> {
   ...
   @Override
   public int compareTo(MovieOld otherMovie) {
    ...
    *
    */
   public static class MovieByRatingDescendingComparator implements Comparator<MovieOld> {
